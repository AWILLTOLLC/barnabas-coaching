...
- **source asset:** what are we adapting from (product description, article, video, demo, launch doc)
...
- **voice:** apply humanizer skill as style pass before delivering any draft
...
6. Run all drafts through humanizer conventions before delivery (no AI tells, no em dashes, no banned phrases).
...
- no generic hype language (apply humanizer banned phrase list)
